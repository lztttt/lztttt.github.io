...
setInterval(function(){
	...
	if (filesize < 512)
		document.getElementById('filesizee').innerHTML = "预计文件大小: <span style='color:green'>"+filesize+"</span> [KB]";
	else
		document.getElementById('filesizee').innerHTML = "预计文件大小: <span style='color:red'>"+filesize+"</span> [KB]";
...
function generateCanvas(ccanvas, cwidth, cheight) {
	...
	document.getElementById('filesizee').innerHTML = "预计文件大小: "+(getEstFileSize()/1024);
}
